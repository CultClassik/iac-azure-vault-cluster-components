...
output "akv_versionless_id_root_ca_pem" {
  description = "Secret ID of AKV secret for private root CA certificate"
  value       = azurerm_key_vault_secret.root_ca_pem.id
}